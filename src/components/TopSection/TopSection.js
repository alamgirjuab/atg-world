...
import { Alert, Modal, Navbar } from 'react-bootstrap';
                ...
                user?.email ?
                    <div className="d-flex col-md-4 align-items-center">
                        <Navbar className="me-3">
                            <NavLink className="text-decoration-none mx-2" to="/addblog">Write Blog</NavLink>
                            <NavLink className="text-decoration-none" to="/deleteblog">Delete Blog</NavLink>
                        </Navbar>
